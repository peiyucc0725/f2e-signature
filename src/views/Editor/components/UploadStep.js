...
const UploadStep = props => {
    ...
    const [uploadFiles, setUploadFiles] = useState(localStorage.getItem('upload-files') || []);
    ...
    return (
        <div className="upload-step">
            <div className="inner">
                <Box className="upload-box" sx={{ bgcolor: 'background.paper', width: '100%' }}>
                    ...
                    <TabPanel className="tab-panel" value={value} index={0}>
                        ...
                        <div className={`file-box${dragActive ? ' drag-active' : ''}`} onClick={onClickUpload} onDragEnter={handleDrag} onDragLeave={handleDrag} onDragOver={handleDrag} onDrop={handleDrop}>
                        ...
                        {uploadFiles && uploadFiles.length > 0 ?
                            <div className='upload-list'>
                                ...
                                {uploadFiles.map((file, index) => {
                                    return (
                                        <div className='upload-list__row' key={index}>
            ...
            <ConfirmDialog open={alertVisible} text={alertText} confirmBtnText="我知道了" alert onConfirm={() => setAlertVisible(false)} />
        </div>
    );
}
